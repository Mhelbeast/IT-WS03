...
$posts = [
  [
    ...
    'excerpt' => 'I’m not the fastest when it comes to designing. Sometimes I spend a lot of time thinking about spacing and colors. When everything feels right, it’s worth it.'
  ],
  [
    'label' => 'GAMING',
  ...
  [
    ...
    'excerpt' => 'I know my designs are not perfect. I still make mistakes and feel slow sometimes. Design is a process, and I’m okay with that.'
  ],
];
  ...
  <main class="container mx-auto px-4 py-8 grid gap-8 lg:grid-cols-12">
    ...
    <aside class="lg:col-span-4 space-y-6 lg:sticky lg:top-8 self-start">
      ...
      <div class="rounded-2xl bg-zinc-50 p-6 shadow-sm space-y-4">
        ...
        <p class="text-sm leading-relaxed text-zinc-700">
          This blog is where I share my designs, thoughts, and progress. I don’t aim to be perfect. I just want to grow, learn, and show my journey as a designer.
        </p>
      </div>
